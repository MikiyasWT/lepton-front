  ...
  datasets: [
    {
      label: '# of Votes',
      data: [20, 40, 46],
      backgroundColor: ['#17c52b', '#1f1fe2', '#df1313'],
      borderColor: ['#17c52b', '#1f1fe2', '#df1313'],
      borderWidth: 0,
    },
  ],
};
...
const MainContentLeft = () => {
  return (
    ...
    <div className="bg-white border-gray-300 py-4 p-2 pb-40 h-auto w-full md:w-1/3 rounded-xl flex flex-col gap-4">
      {/* Title and Date */}
      {/* this is component1 */}
      ...
      {/* Income Section */}
      <div className="bg-white sm:h-3 md:h-40 border-gray-300 shadow-xl rounded-xl">
        ...
        <div className="w-full h-auto flex flex-col gap-1">
          ...
          <div className="text-center items-center">
            <span className="text-gray-400 text-sm">Compared to ETB 9460 last month</span>
          </div>
          <div className="text-center items-center">
      ...
      {/* this is end of component1 */}

      {/* this is component2 */}
      {/* Donut Chart Section */}
      <div className="h-64 md:h-48 border border-gray-100 shadow-lg rounded-xl  flex items-center justify-center">
